...
def gen_vocab(
    ...
    spm.Load("{0}.model".format(output_path_prefix.as_posix()))
...
def gen_config_yaml(
    ...
    asr_spm_filename: Optional[str] = None,
    share_src_and_tgt: Optional[bool] = False,
):
...
class S2TDataConfigWriter(object):
    ...
    def set_asr_vocab_filename(self, vocab_filename: str = "dict.txt"):
        self.config["asr_vocab_filename"] = vocab_filename

    def set_asr_vocab_filename(self, vocab_filename: str = "dict.txt"):
        self.config["asr_vocab_filename"] = vocab_filename

    def set_share_src_and_tgt(self, share_src_and_tgt: bool = False):
        self.config["share_src_and_tgt"] = share_src_and_tgt
